...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/todos","GOAPP_STATIC_RESOURCES_URL":"/todos","GOAPP_VERSION":"bbb6dbe40971facc686751171ea73a01a155526c"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/todos/web/app.wasm", showProgress),
      go.importObject
    );
